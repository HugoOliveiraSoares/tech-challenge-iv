...
class CriticalNotificationEmailComposerTest {
    ...
    private final CriticalNotificationEmailComposer composer = new CriticalNotificationEmailComposer();
    ...
    void montaEmailComDescricaoUrgenciaDataEnvioERastreabilidade() {
        ...
        assertTrue(email.body().contains("Descricao: A aula estava confusa e nao consegui acompanhar o conteudo."));
        assertTrue(email.body().contains("Urgencia: CRITICA"));
        assertTrue(email.body().contains("Data de envio: 2026-05-31 13:00:00 UTC"));
